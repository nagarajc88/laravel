...
<head>
	...
	<link rel="icon" type="image/png" href="{{ asset('public/img/favicons/favicon-32x32.png') }}" sizes="32x32">
	<link rel="icon" type="image/png" href="{{ asset('public/img/favicons/favicon-16x16.png') }}" sizes="16x16">
	<link rel="manifest" href="{{ asset('public/img/favicons/manifest.json') }}">
	<link rel="shortcut icon" href="{{ asset('public/img/favicons/favicon.ico') }}">
	<meta name="msapplication-TileColor" content="#00a8ff">
	<meta name="msapplication-config" content="{{ asset('public/img/favicons/browserconfig.xml') }}">
	...
	<!-- Owl -->
	<link rel="stylesheet" type="text/css" href="{{ asset('public/css/owl.css') }}">
	<!-- Animate.css -->
	<link rel="stylesheet" type="text/css" href="{{ asset('public/css/animate.css') }}">
	<!-- Font Awesome -->
	<link rel="stylesheet" type="text/css" href="{{ asset('public/fonts/font-awesome-4.1.0/css/font-awesome.min.css') }}">
	<!-- Elegant Icons -->
	<link rel="stylesheet" type="text/css" href="{{ asset('public/fonts/eleganticons/et-icons.css') }}">
	<!-- Main style -->
	<link rel="stylesheet" type="text/css" href="{{ asset('public/css/cardio.css') }}">
</head>

<body>
	<div class="preloader">
		<img src="{{ asset('public/img/loader.gif') }}" alt="Preloader image">
	</div>
	<nav class="navbar">
		<div class="container">
		...
		<div class="container">
			...
			<div class="row services">
				<div class="col-md-4">
					<div class="service">
						<div class="icon-holder">
							<img src="{{ asset('public/img/icons/heart-blue.png') }}" alt="" class="icon">
						</div>
				...
				<div class="col-md-4">
					<div class="service">
						<div class="icon-holder">
							<img src="{{ asset('public/img/icons/guru-blue.png') }}" alt="" class="icon">
						</div>
				...
				<div class="col-md-4">
					<div class="service">
						<div class="icon-holder">
							<img src="{{ asset('public/img/icons/weight-blue.png') }}" alt="" class="icon">
						</div>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="team text-center">
						<div class="cover" style="background:url('{{ asset('public/img/team/team-cover1.jpg') }}'); background-size:cover;">
							<div class="overlay text-center">
								<h3 class="white">$69.00</h3>
								<h5 class="light light-white">1 - 5 sessions / month</h5>
							</div>
						</div>
						<img src="{{ asset('public/img/team/team3.jpg') }}" alt="Team Image" class="avatar">
						<div class="title">
							<h4>Ben Adamson</h4>
				...
				<div class="col-md-4">
					<div class="team text-center">
						<div class="cover" style="background:url('{{ asset('public/img/team/team-cover2.jpg') }}'); background-size:cover;">
							<div class="overlay text-center">
								<h3 class="white">$69.00</h3>
								<h5 class="light light-white">1 - 5 sessions / month</h5>
							</div>
						</div>
						<img src="{{ asset('public/img/team/team1.jpg') }}" alt="Team Image" class="avatar">
						<div class="title">
							<h4>Eva Williams</h4>
				...
				<div class="col-md-4">
					<div class="team text-center">
						<div class="cover" style="background:url('{{ asset('public/img/team/team-cover3.jpg') }}'); background-size:cover;">
							<div class="overlay text-center">
								<h3 class="white">$69.00</h3>
								<h5 class="light light-white">1 - 5 sessions / month</h5>
							</div>
						</div>
						<img src="{{ asset('public/img/team/team2.jpg') }}" alt="Team Image" class="avatar">
						<div class="title">
							<h4>John Phillips</h4>
							<h5 class="muted regular">Personal Trainer</h5>
						</div>
	...
	<script src="{{ asset('public/js/jquery.onepagenav.js') }}"></script>
